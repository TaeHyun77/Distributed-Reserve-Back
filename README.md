...
7. 매진 시나리오
   ...
   N=2,000명으로 10,000석을 소진한 결과 oversell 0건으로 정확히 완료되었습니다. 총 74,953건의 좌석 충돌(409)도 조건부 UPDATE가 모두 정상 거부했으며, 약 185초(3분)에 10,000석이 정확히 1번씩 판매됐습니다. 매진 직전 경합으로 confirm p99가 5,614ms까지 증가했지만, 매진 시나리오의 핵심 목표인 중복 예약 방지와 정확한 완판은 모두 달성했습니다.
